    ...
    <div className={`mt-[150px] bg-black-100 rounded-[20px] flex justify-center content-center flex-column text-center`} id='feedbacks'>
      ...
      >
        <motion.div variants={textVariant()}>
          <p className={styles.sectionSubText}>Seguinos en las redes</p>
          <h2 className={styles.sectionHeadText}>Mis Clientes</h2>
        </motion.div>
      </div>
      <div className={`-mt-20 pb-14 ${styles.paddingX} flex flex-wrap gap-8  justify-center items-center text-center`}>
